...
{REGARDS}',
	...
	'notify_boards_once_body' => array(
		/*
			...
			@description:
		*/
		'subject' => 'New Topic: [ {POSTERNAME} ] {TOPICSUBJECT}',
		'body' => 'A new topic, \'{TOPICSUBJECT}\', has been made by {POSTERNAME} on the board "{BOARDNAME}".
...
{REGARDS}',
	...
	'notification_reply' => array(
		/*
			...
			@description:
		*/
		'subject' => 'Topic reply: [ {POSTERNAME} ] {TOPICSUBJECT}',
		'body' => 'A reply has been posted to the topic "{TOPICSUBJECT}" you are watching by {POSTERNAME}.
