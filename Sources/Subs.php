			...
			switch($spoilerTagStyle)
            {
				case 3:
					$retval = (
						...
						'<input type="button" class="spoilerbutton" value="'.$topic.'" '.
				...
				case 2:
					$retval = (
						...
						'onclick="n = this.parentNode.parentNode.lastChild; if(n.style.display == \'none\') { n.style.display = \'block\'; } else {	n.style.display = \'none\';	} return false;">'.$topic.'</a> '.
						$txt['spoiler_tag_click_info'].'</div><div class="spoilerbody" style="display: none">'
					);
				break;
				...
				default:
					$retval = (
						...
						'<legend><b>'.$topic.'</b> <small>'.$txt['spoiler_tag_hover_info'].'</small>'.
